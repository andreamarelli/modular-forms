...
window.ModularFormsVendor.Vue.component('tooltip', require('./js/templates/tooltip.vue').default);
...
window.ModularFormsVendor.Vue.component('simple-text', require('./js/inputs/simple-text.vue').default);
